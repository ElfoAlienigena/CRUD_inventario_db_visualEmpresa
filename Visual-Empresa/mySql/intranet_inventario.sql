...
--
-- Servidor: localhost
-- Tiempo de generación: 15-01-2026 a las 23:57:07
...
--
-- Base de datos: `intranet_inventario`
--
...
ALTER TABLE `historial_movimientos`
  ...
  ADD CONSTRAINT `historial_movimientos_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`);
